...
[`DocumentationExamplesTests.cs`](tests/DocumentationExamplesTests.cs), so the documentation
...
semantics. [DESIGN.md](DESIGN.md) covers the architecture and the deliberate divergences;
